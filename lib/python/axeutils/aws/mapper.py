...
"""
A simple library of AWS utility functions that are used regularly by AXE tools
"""
...
from axeutils import clean_up, CONST_AXE_ROOT, check_imports
...
def _validate_environment():
    ...
    # Make sure we have AXE_ROOT before going any further
    if CONST_AXE_ROOT is None:
        _log.error('The AXE_ROOT environment variable was not found. Try not being an idiot.')
        sys.exit(1)
