...
from axeutils.aws.legacy.utils import CONST_AXE_ROOT, IterRegistry
from os import walk
    ...
    def parse(self):
        ...
        for config_object in object_list:
            ...
            for attribute in all_attributes:
                ...
                # Replace the AXE_ROOT variable with the current value if present
                value = value.replace('$AXE_ROOT', CONST_AXE_ROOT)
...
class ConfigManager(object):
    ...
    def __init__(self, config_map, env_name=None, config_path=None):
        ...
        :param env_name Dir in $AXE_ROOT/etc/cloudbuilder containing configs
        :param config_path Path in $AXE_ROOT containing configs
        '''
        ...
        if env_name:
            ...
            conf_dir = CONST_AXE_ROOT + '/' + config_path
